...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Document>()
            .HasOne(d => d.UploadedByUser).WithMany(u => u.UploadedDocuments)
            .HasForeignKey(d => d.UploadedByUserId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<Document>().HasOne(d => d.Project).WithMany(p => p.Documents)
            .HasForeignKey(d => d.ProjectId).OnDelete(DeleteBehavior.SetNull);
        modelBuilder.Entity<Document>().HasOne(d => d.Task).WithMany(t => t.Documents)
        ...
        modelBuilder.Entity<Document>().HasIndex(d => new { d.ProjectId, d.UploadedAt });
        modelBuilder.Entity<Document>().HasIndex(d => d.Category);
        modelBuilder.Entity<Document>().HasIndex(d => d.UploadedAt);
        modelBuilder.Entity<DocumentShare>().HasOne(s => s.Document).WithMany(d => d.Shares)
            .HasForeignKey(s => s.DocumentId).OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<DocumentShare>().HasOne(s => s.SharedWithUser).WithMany(u => u.ReceivedDocumentShares)
            .HasForeignKey(s => s.SharedWithUserId).OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<DocumentShare>().HasOne(s => s.SharedByUser).WithMany(u => u.GrantedDocumentShares)
        ...
        modelBuilder.Entity<DocumentActivity>().HasOne(a => a.Document).WithMany(d => d.Activities)
            .HasForeignKey(a => a.DocumentId).OnDelete(DeleteBehavior.SetNull);
        modelBuilder.Entity<DocumentActivity>().HasOne(a => a.ActorUser).WithMany(u => u.DocumentActivities)
            .HasForeignKey(a => a.ActorUserId).OnDelete(DeleteBehavior.SetNull);
        modelBuilder.Entity<DocumentActivity>().HasIndex(a => new { a.DocumentId, a.OccurredAt });
